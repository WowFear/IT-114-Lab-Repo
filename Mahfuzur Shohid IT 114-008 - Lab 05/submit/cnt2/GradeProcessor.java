    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (fileScanner.hasNext()) {
                ...
                writer.printf("%-10s\t%d\t%d\t%d\t%.1f\t%s%n", name, score1, score2, score3, average, status);
            }
        ...
        // TODO 6: catch block — this runs if the file doesn't exist or can't be opened
            ...
            System.out.println("Error: Input file 'student_data.txt' was not found — " + e.getMessage());
        }
    }
}