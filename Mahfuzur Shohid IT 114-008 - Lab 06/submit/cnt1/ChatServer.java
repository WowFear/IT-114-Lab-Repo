    ...
    public static void main(String[] args) {
        ...
        try {
            //TODO: Create ServerSocket to listen on port
                ...
                System.out.println("The Server has started, just waiting for the Client on port, " + port + "."); 
...
//I pretty much mimic the same code I had from the Client over to the Server, obvously with the respective variables, no reason to just say the same thing in my comments.