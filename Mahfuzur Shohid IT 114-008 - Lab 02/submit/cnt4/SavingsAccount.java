public class SavingsAccount extends BankAccount {
    ...
    public void withdraw(double amount) {
        ...
        if(amount > getBalance()){
            ...
            System.out.println("Transaction Denied: Insufficient funds"); //So since this is a savings accoount do not allow for an overdraft fee, we dont have to immplment it.
